...
plot_stacked_bar_percentage <- function(df, cluster_col, attribute_col) {
    df= df [,2:ncol(df)]
...
```{r}
plot_stacked_bar_percentage(df.sample,'lipid_cluster','batch')
plot_stacked_bar_percentage(df.sample,'lipid_cluster','CODEX主要亚型')
plot_stacked_bar_percentage(df.sample,'lipid_cluster','smoke')
