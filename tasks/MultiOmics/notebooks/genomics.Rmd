...
```{r}
foldchanges=df.test_results[,'fc']
names(foldchanges)=df.test_results[,'ENTREZID']
...
gseaplot2(kk2,  title = description_name, geneSetID = which(kk2$Description==description_name))
