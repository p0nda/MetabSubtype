...
edger.test.results=glmLRT(fit)$table
logFC <- glmLRT(fit)$table$logFC
dim(v$E)
v_corrected.edger=as.data.frame(t(v$E))
rna_num=ncol(v_corrected.edger)

mean_group1 <- mean(df.using[df.using[class_label]==1,'ENSG00000116748' ])
mean_group2 <- mean(df.using[df.using[class_label]==2,'ENSG00000116748' ])
mean_group1
mean_group2
